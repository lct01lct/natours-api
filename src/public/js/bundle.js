...
var showAlert = function showAlert(type, msg) {
  ...
  markup.className = "alert alert--".concat(type);
...
exports.logout = exports.initLoginPage = void 0;
...
var initLoginPage = function initLoginPage() {
  ...
  oForm === null || oForm === void 0 ? void 0 : oForm.addEventListener('submit', function (e) {
    e.preventDefault();
...
exports.initAccountPage = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var initAccountPage = function initAccountPage() {
  var oUserForm = document.querySelector('.form-user-data');
  if (oUserForm) {
    oUserForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 5;
              return updateSettings(name, email);
            case 5:
            case "end":
              return _context2.stop();
          }
...
exports.initAccountPage = initAccountPage;
...
initHeader();
(0, _login.initLoginPage)();
(0, _updateSettings.initAccountPage)();
function initHeader() {
  var oLogoutBtn = document.querySelector('.nav__el--logout');
  if (oLogoutBtn) {
    oLogoutBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
...
},{"./login":"login.js","./updateSettings":"updateSettings.js"}],"../../../node_modules/.pnpm/parcel-bundler@1.12.5/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
